...
function App() {
  ...
  useEffect(() => {
    ...
    const assignmentNumberParam = searchParamss.get('Query');
   const Studentidparam = searchParams.get('sid');
   setStudentid(Studentidparam);
    setEmail(emailParam);
    setFinalQuery(assignmentNumberParam);
  }, []);
            ...
            <div className="mb-3">
              ...
              >
                {showDatabaseForm && (
                  ...
                  >
                    <h7 style={{ marginBottom: "1rem" }}>Select a database</h7>
                    <select
                      id="databaseSelect"
                    ...
                    >
                      ...
                      <option value="ILEFT JOIN">LEFT JOIN</option>
